...
<body class="hold-transition skin-green sidebar-mini">
  ...
  try {$sql = "INSERT INTO notice(notice,odience,`date`) VALUES ('".$notice."', '".$odience."', now())";
  ...
  while($row = $result->fetch_assoc()) {
   ...
   <td> " . $row["notice"]." </td>
   <td> " . $row["date"]." </td>
   <td><button class='btn btn-danger'><a href='Notice.php?delete=". $row["id"]."'><small class='text-light'>delete</small></a></button></td>
      </tr>";} }
